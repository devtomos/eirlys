...
from classes.normalCommands.generalClasses import *
...
async def GeneralDB(connect):
    global sql
    sql = connect
    return print("| -- General DB is now online.")
...
class General(commands.Cog):
    ...
    async def on_ready(self):
        print("| -- General Command is now online.")
    ...
    async def banner(self, ctx, member: nextcord.Member = None):
        ...
        try: member = await self.client.fetch_member(member.id)
